...
if(!class_exists('quickbuy_auto_update')) {
    ...
    add_action('init', 'manhphuc_quickbuy_auto_update' );
    function manhphuc_quickbuy_auto_update()
    {
        ...
        $manhphuc_plugin_current_version = MANHPHUC_QB_VERSION_NUM;
        $manhphuc_plugin_remote_path = 'http://license.yivic.com/wp-admin/admin-ajax.php?action=manhphuc_update&slug=manhphuc-quick-buy&getremote=update&license='.$license_key;
        $manhphuc_plugin_slug = MANHPHUC_QB_BASENAME;
        new quickbuy_auto_update ($manhphuc_plugin_current_version, $manhphuc_plugin_remote_path, $manhphuc_plugin_slug);
    }
}