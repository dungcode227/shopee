...
Thông tin thêm [về plugin này](http://yivic.com/san-pham/plugin-mua-hang-nhanh-cho-woocommerce-woocommerce-quick-buy/).
...
* Update: Cập nhật Shortcode hiển thị nút mua hàng.
    - Shortcode dạng [manhphuc_quickbuy id="{ID}" button_text1="Ví dụ" button_text2 = "Ví dụ sub text" small_link="{1,0}"]
    - Bắt buộc phải có id của sản phẩm id="{ID}" ví dụ [manhphuc_quickbuy id="68"]
    ...
    * Ví dụ muốn hiển thị tại 1 page nào đó hoặc tại bất kỳ đâu thì dùng shortcode như sau
        [manhphuc_quickbuy id="36" button_text1="Ví dụ" button_text2 = "Ví dụ sub text"]
        Hoặc
        [manhphuc_quickbuy id="35"]
        Hoặc dạng text link thì
        [manhphuc_quickbuy id="35" small_link="1"]

    * Ví dụ muốn hiển thị thêm 1 button mua nhanh ngay trong trang chi tiết sản phẩm (single product) thì dạng như sau
        [manhphuc_quickbuy id="36" view="0"]

    * Đối với theme Flatsome khi bạn sử dụng customizer product page thì hãy sử dụng shortcode [manhphuc_quickbuy] vào chỗ cần thêm
...
* Update: Tương thích với plugin Woo vs GHTK - https://yivic.com/san-pham/plugin-ket-noi-giao-hang-tiet-kiem-voi-woocommerce-ghtk-vs-woocommerce/